...
MICROBE_MASST = SpecialMasst(
    prefix="microbe",
    root="microbes",
    tree_file=f"data/microbe_masst_tree.json",
    metadata_file=f"data/microbe_masst_table.csv",
    tree_node_key="NCBI",
...
FOOD_MASST = SpecialMasst(
    prefix="food",
    root="food",
    tree_file=f"data/food_masst_tree.json",
    metadata_file=f"data/food_masst_table.csv",
    tree_node_key="name",
...
PLANT_MASST = SpecialMasst(
    prefix="plant",
    root="plants",
    tree_file=f"data/plant_masst_tree.json",
    metadata_file=f"data/plant_masst_table.csv",
    tree_node_key="NCBI",
    metadata_key="Taxa_NCBI",
)
TISSUE_MASST = SpecialMasst(
    prefix="tissue",
    root="tissue",
    tree_file=f"data/tissue_masst_tree.json",
    metadata_file=f"data/tissue_masst_table.csv",
    tree_node_key="ID",
    metadata_key="ID",
)
PERSONALCAREPRODUCT_MASST = SpecialMasst(
    ...
    tree_file=f"data/personalCareProduct_masst_tree.json",
    metadata_file=f"data/personalCareProduct_masst_table.csv",
    tree_node_key="name",
    metadata_key="node_id",
)
MICROBIOME_MASST = SpecialMasst(
    prefix="microbiome",
    root="microbiome",
    tree_file=f"data/microbiome_masst_tree.json",
    metadata_file=f"data/microbiome_masst_table.tsv",
    tree_node_key="name",
    metadata_key="node_id",
)
