...
def merge_tsv_files_by_schema(input_directory, output_directory, pattern=r"_counts_.*\.tsv$"):
    ...
    """
    schema_files = {}  # Dictionary to hold files grouped by their schema
    ...
    # Step 2: Process each schema group
...
# python /workspaces/microbe_masst/files/test_mai/merge_tsvs.py -i /workspaces/microbe_masst/files/test_mai/out_dir -o /workspaces/microbe_masst/files/test_mai/out_dir