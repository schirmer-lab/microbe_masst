...
"""
Code to create tree from newick file. Goal check microbeMASST DB, but better code in visualize_db_from_json!
"""
...
# python visualize_database.py --nw "../trees/microbe_masst_tree/microbemasst_tree_trimmed.nw" -o "output_vis_db" -p "db_microbe_trimmed"