...
"python pipeline/create_mapping_table.py --feature_counts output/test_filterOut/filtered_summary_counts_microbe.tsv --sample_species files/Bacterial_strain_ID.xlsx --expression_table files/neg_expression.tsv -o output/mapping.tsv"
